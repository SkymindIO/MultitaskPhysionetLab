...
/**
 * Trains a MLP to predict survival using the Physionet Challenge
 ...
 *
 * Rather than use raw survival, we convert the problem into a multiclass
 * classification task by grouping survival into five buckets: one week or less,
 * a week to a month, a month to a year, and longer than a year, with one bucket
 * dedicated to patients with an unknown survival time.
 *
...
public class SingleTaskSurvivalModel {
    ...
    public static final int NB_TARGETS = 5; // survival bucket
    ...
    private static File labelsDir = new File(baseDir, "survival_bucket");
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        ComputationGraphConfiguration config = new NeuralNetConfiguration.Builder()
                ...
                .setOutputs("lossSurvival") // names of outputs (i.e., where loss is compute)

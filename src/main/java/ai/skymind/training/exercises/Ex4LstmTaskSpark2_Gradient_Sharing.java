...
public class Ex4LstmTaskSpark2_Gradient_Sharing {
    private static File baseDir = new File("resourcesP/physionet2012/");
    ...
    private static final Logger log = LoggerFactory.getLogger(Ex4LstmTaskSpark2_Gradient_Sharing.class);
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        TrainingMaster tm = new SharedTrainingMaster.Builder(voidConfiguration,BATCH_SIZE)
